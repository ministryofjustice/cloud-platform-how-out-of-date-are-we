module ministryofjustice/cloud-platform-how-out-of-date-are-we/reports/namespace-resource-committment

go 1.20

require (
	github.com/ministryofjustice/cloud-platform-environments v1.2.1-0.20230613173103-277430a45f74
	k8s.io/api v0.27.2
